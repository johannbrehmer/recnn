...
MODEL_DIR=$SCRATCH/models/gilles/

let 'SEED=SLURM_ARRAY_TASK_ID * 1000'

python train.py $DATA_DIR/antikt-kt-train.pickle $MODEL_DIR/model-gilles-$SLURM_ARRAY_TASK_ID.pickle --random_state=$SEED --n_epochs=20
